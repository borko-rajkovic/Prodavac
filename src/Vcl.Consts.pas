...
{$IFEND}
  ...
  SMsgDlgError = 'Greška';
  SMsgDlgInformation = 'Obavještenje';
  SMsgDlgConfirm = 'Potvrdi';
  SMsgDlgYes = '&Da';
  SMsgDlgNo = '&Ne';
  SMsgDlgOK = 'OK';
  SMsgDlgCancel = 'Otkaži';
  SMsgDlgHelp = '&Pomoć';
  SMsgDlgHelpNone = 'No help available';
  SMsgDlgHelpHelp = 'Help';
  SMsgDlgAbort = '&Abortiraj';
  SMsgDlgRetry = '&Pokušaj opet';
  SMsgDlgIgnore = '&Ignoriši';
  SMsgDlgAll = '&Sve';
  SMsgDlgNoToAll = 'N&e za Sve';
  SMsgDlgYesToAll = 'Da za &Sve';
  SMsgDlgClose = '&Zatvori';
